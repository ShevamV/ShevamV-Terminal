//const config = {
    ...
    'story --thirsty crow': 'Once upon a time, in a hot summer day, a thirsty crow searched for water everywhere. At last, it found a pitcher with a little water at the bottom. The crow couldn\'t reach the water, so it collected pebbles and dropped them one by one into the pitcher until the water level rose, and the crow could quench its thirst.',
    'story --any story': 'Here is any story you want to provide as the result of the "story --any story" command.',
    // Add more commands and their corresponding results here
    'command1': 'Result for command1',
    'command2': 'Result for command2',
    'command3': 'Result for command3',
    'command4': 'Result for command4',
    'command5': 'Result for command5',
    'command6': 'Result for command6',
    'command7': 'Result for command7',
    'command8': 'Result for command8',
    'command9': 'Result for command9',
    'command10': 'Result for command10'
//};
// remove the // from the below code if You want.
